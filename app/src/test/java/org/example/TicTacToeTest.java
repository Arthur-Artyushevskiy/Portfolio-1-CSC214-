...
public class TicTacToeTest {
    ...
    void testTicChangeValidMove() {
        // ticChange returns true if the move is valid and space is empty
    ...
    void testTicChangeInvalidOutOfBounds() {
        // ticChange returns false if coordinates are outside 1-3
    ...
    void testTicChangeAlreadyTaken() {
        // ticChange returns false if the space is already occupied
    ...
    void testCheckHorWin() {
        // Manually setting a horizontal win for X in row 1
        game.matrix[0][0] = 'X';
        game.matrix[0][1] = 'X';
        game.matrix[0][2] = 'X';
    ...
    void testCheckVerWin() {
        // Manually setting a vertical win for O in column 2
        game.matrix[0][1] = 'O';
        game.matrix[1][1] = 'O';
        game.matrix[2][1] = 'O';
